...
const RU: Dict = {
  ...
  'schedule.freezeBooking': 'Не приду',
  'schedule.cantAttend': 'Не смогу прийти',
  'schedule.excused': 'Не приду',
  'schedule.unfreeze': 'Снова приду',
  'schedule.unfreeze.success': 'Вы снова записаны на занятие',
  'schedule.unfreeze.error': 'Не удалось изменить статус',
  'schedule.freeze.title': 'Не смогу прийти',
  'schedule.freeze.subtitle': 'Отметить что не придёте на тренировку',
  'schedule.freeze.info': 'Ваше место останется за вами, но тренер будет знать что вас не будет.',
  'schedule.freeze.noteLabel': 'Причина',
  'schedule.freeze.optional': 'необязательно',
  'schedule.freeze.notePlaceholder': 'Например: заболел, дела на работе...',
  'schedule.freeze.confirm': 'Подтвердить',
  'schedule.freeze.success': 'Тренер получит уведомление о вашем отсутствии',
  'schedule.freeze.error': 'Не удалось отметить отсутствие',
...
const KK: Dict = {
  ...
  'schedule.freezeBooking': 'Келмеймін',
  'schedule.cantAttend': 'Келе алмаймын',
  'schedule.excused': 'Келмеймін',
  'schedule.unfreeze': 'Қайта келемін',
  'schedule.unfreeze.success': 'Сіз қайта жаттығуға жазылдыңыз',
  'schedule.unfreeze.error': 'Статусты өзгерту сәтсіз аяқталды',
  'schedule.freeze.title': 'Келе алмаймын',
  'schedule.freeze.subtitle': 'Жаттығуға келмейтініңізді белгілеу',
  'schedule.freeze.info': 'Сіздің орныңыз сақталады, бірақ жаттықтырушы сіздің келмейтініңізді білетін болады.',
  'schedule.freeze.noteLabel': 'Себеп',
  'schedule.freeze.optional': 'міндетті емес',
  'schedule.freeze.notePlaceholder': 'Мысалы: ауырып қалдым, жұмыс істері...',
  'schedule.freeze.confirm': 'Растау',
  'schedule.freeze.success': 'Жаттықтырушы сіздің келмейтініңіз туралы хабарлама алады',
  'schedule.freeze.error': 'Келмейтінді белгілеу сәтсіз аяқталды',
