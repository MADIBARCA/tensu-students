...
const RU: Dict = {
  ...
  'profile.cards.title': 'Платежные карты',
  'profile.cards.loadError': 'Не удалось загрузить карты',
  'profile.cards.registerError': 'Не удалось начать регистрацию карты',
  'profile.cards.deleteConfirm': 'Вы уверены, что хотите удалить эту карту?',
  'profile.cards.deleteError': 'Не удалось удалить карту',
  'profile.cards.registering': 'Подключение...',
  'profile.cards.addCard': 'Добавить карту',
  'profile.cards.info': 'Сохраните карту для быстрой оплаты в один клик',
  'profile.cards.savedCount': '{count} карт сохранено',
  'profile.cards.active': 'Активна',
...
const KK: Dict = {
  ...
  'profile.cards.title': 'Төлем карталары',
  'profile.cards.loadError': 'Карталарды жүктеу мүмкін болмады',
  'profile.cards.registerError': 'Картаны тіркеуді бастау мүмкін болмады',
  'profile.cards.deleteConfirm': 'Бұл картаны жойғыңыз келетініне сенімдісіз бе?',
  'profile.cards.deleteError': 'Картаны жою мүмкін болмады',
  'profile.cards.registering': 'Қосылуда...',
  'profile.cards.addCard': 'Карта қосу',
  'profile.cards.info': 'Бір кликпен жылдам төлеу үшін картаңызды сақтаңыз',
  'profile.cards.savedCount': '{count} карта сақталған',
  'profile.cards.active': 'Белсенді',
