      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-500 via-red-600 to-rose-700 px-4">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 max-w-sm w-full text-center">
          ...
          <button
            ...
            className="w-full py-3 px-6 bg-gradient-to-r from-[#1E3A8A] to-[#2563EB] text-white font-semibold rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl"
          >
          ...
          <div className="px-8 py-6">
            {!phone ? (
              <button
                ...
                className="w-full py-4 px-6 bg-gradient-to-r from-[#1E3A8A] to-[#2563EB] hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-2xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-3 group"
              >
