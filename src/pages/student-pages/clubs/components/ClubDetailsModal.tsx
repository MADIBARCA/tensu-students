                ...
                {club.phone && (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm font-medium text-[#1E3A8A]">{formatPhone(club.phone)}</p>
                    </div>
              ...
              {coaches.length > 0 && (
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {coaches.length > 4 && (
                      <button className="text-xs text-[#1E3A8A] font-medium">
                      ...
                      <Card key={membership.membershipId} className="p-4 border-2 border-[#10B981] bg-linear-to-br from-[#ECFDF5] to-white relative overflow-hidden">
                        ...
                        <div className="flex items-start justify-between mb-3 pr-20">
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                              ...
                              <span className="text-xs text-[#059669] font-medium">{getPackageTypeLabel(membership.packageType)}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-white/60 rounded-xl p-3 mb-4 border border-[#A7F3D0]">
                          ...
                          <div className="mt-2 flex items-center justify-between">
                            ...
                            <span className={`text-sm font-semibold ${getDaysRemaining(membership.endDate) <= 7 ? 'text-amber-600' : 'text-[#059669]'}`}>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {membership.includedSections.map((section) => (
                                <span 
                                  ...
                                  className="inline-flex items-center gap-1 px-2 py-1 bg-blue-100 text-[#1E3A8A] rounded-lg text-xs font-medium"
                                >
                                  <Layers size={12} />
                                  {section.name}
                                </span>
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            {membership.status !== 'frozen' ? (
                              ...
                              <button
                                ...
                                className="px-3 py-2.5 bg-blue-50 text-[#1E3A8A] rounded-xl text-sm font-medium flex items-center justify-center gap-2 hover:bg-blue-100 transition-colors"
                              >
                                <Snowflake size={16} />
                        ...
                        {membership.isTariffDeleted && membership.status === 'frozen' && (
                          <button
                            ...
                            className="w-full px-3 py-2.5 bg-blue-50 text-[#1E3A8A] rounded-xl text-sm font-medium flex items-center justify-center gap-2 hover:bg-blue-100 transition-colors"
                          >
                            <Snowflake size={16} />
                            {t('clubs.membership.unfreeze')}
                          </button>
                            ...
                            {(() => {
                              ...
                              return ep.isDiscounted ? (
                                <>
                                  ...
                                  <p className="text-xl font-bold text-[#059669]">{formatPrice(ep.price)}</p>
                                </>
                              ) : (
                      ...
                      <div className="flex items-start justify-between mb-2">
                        ...
                        {(() => {
                          ...
                          return ep.isDiscounted ? (
                            <>
                              <span className="text-sm text-gray-400 line-through">{formatPrice(plan.price)}</span>
                              <p className="text-lg font-bold text-[#059669]">{formatPrice(ep.price)}</p>
                            </>
                          ) : (
                ...
                <div className="space-y-3">
                  ...
                  {scheduledMemberships.map((membership) => (
                    <Card key={membership.membershipId} className="p-4 border-2 border-blue-200 bg-blue-50/30 relative overflow-hidden">
                      <div className="absolute top-0 right-0">
                        <div className="bg-[#1E3A8A] text-white text-[10px] font-semibold px-3 py-1 rounded-bl-lg flex items-center gap-1">
                          <Calendar size={12} />
                      ...
                      <div className="flex items-start justify-between mb-3 pr-20">
                        ...
                        <div className="text-right">
                          <p className="text-xl font-bold text-[#1E3A8A]">{formatPrice(membership.price)}</p>
                        </div>
                      </div>
                      ...
                      {(membership.includedSections.length > 0 || membership.includedGroups.length > 0) && (
                        <div className="flex flex-wrap gap-1 mb-3">
                          {membership.includedSections.slice(0, 2).map((section) => (
                            <span 
                              key={`section-${section.id}`} 
                              className="inline-flex items-center gap-0.5 px-1.5 py-0.5 bg-blue-100 text-[#1E3A8A] rounded text-[10px] font-medium"
                            >
                              <Layers size={10} />
                              {section.name}
                            </span>
                                ...
                                <div className="text-right shrink-0">
                                  {effectivePrice.isDiscounted ? (
                                    <>
                                      ...
                                      <p className="text-2xl font-bold text-[#059669]">{formatPrice(effectivePrice.price)}</p>
                                      <p className="text-[10px] text-[#059669] font-medium">{t('clubs.priceRequest.yourPrice')}</p>
                                    </>
                                  ) : (
                                    <>
                                      <p className="text-2xl font-bold text-[#1E3A8A]">{formatPrice(plan.price)}</p>
                              ...
                              <div className="space-y-2">
                                <button
                                  ...
                                  className={`w-full px-4 py-3 rounded-xl font-medium transition-all flex items-center justify-center gap-2 ${
                                    isPopular
                                      ? 'bg-[#1E3A8A] text-white hover:bg-[#1E3A8A] shadow-md'
